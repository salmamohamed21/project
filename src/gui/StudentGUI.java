...
public class StudentGUI extends javax.swing.JFrame {
    ...
    public void appendNotification(String notification) {
      ...
      public void setStudentName(String name) {
        jLabel1.setText(name); // Assuming jLabel1 is for the student name
    }

     // Method to display notifications in JTextArea
    public void displayNotifications(List<String> notifications) {
        StringBuilder notificationText = new StringBuilder();
        for (String notification : notifications) {
            notificationText.append(notification).append("\n");
        }
        jTextArea1.setText(notificationText.toString()); // Assuming jTextArea1 is for notifications
    }
    
     // Method to display courses and grades in jTable1
    public void displayCoursesAndGrades(List<CourseGrade> courseGrades) {
        DefaultTableModel model = (DefaultTableModel) jTable1.getModel();
        model.setRowCount(0); // Clear existing rows

        for (CourseGrade courseGrade : courseGrades) {
            model.addRow(new Object[]{courseGrade.getCourseName(), courseGrade.getGrade()});
        }
    }
    ...
    private void initComponents() {
        ...
        jTabbedPane1.addTab("notifecation", jPanel1);
        ...
        jTabbedPane1.addTab("view grade", jPanel2);
